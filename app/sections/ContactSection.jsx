...
export default function ContactSection() {
    return (
        <section className="lg:px-24 px-4 my-8 flex flex-col relative items-center after:absolute after:h-[25rem] after:aspect-square after:rounded-full after:bg-primary-soft after:top-2/3 after:blur-[120px] sm:after:block after:hidden after:-z-[1] after:-translate-y-1/2 after:sm:opacity-70 after:opacity-40 after:animate-pulse" id="contact">
