...
export default function NavSection({type}) {
    ...
    return (
        <navContect.Provider value={{ isColapsed, setIsColapsed, currentNav, setCurrentNav }}>
            <nav className={`text-white lg:px-24 px-6 sm:py-4 py-2 flex items-center justify-between ${type === 0 ? "dark:bg-white/20 bg-black/5" : "fixed min-w-[100vw] top-0 backdrop-blur-md sm:mb-[-12%] mb-[-30%] z-[101] dark:bg-transparent bg-black/5 "}`}>
